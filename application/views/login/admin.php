		...
		<form class="form" method="post" action="<?=site_url();?>login">
			<div class="login-box">
				<div class="register-logo">
					<img src="<?=base_url();?>assets/img/lokalogo.png" width="200px">
					<p><b>CMS</b></p>
				</div>
				<div class="box box-solid box-warning">
					...
					<div class="box-footer">
						<div class="form-group">
							<button type="submit" class="btn btn-primary btn-block" id="bsubmit" name="bsubmit"><b>Login</b></button>
							<a href="<?= site_url(); ?>/" class="btn bg-black-active btn-block btn-sm" id="bback">Kembali ke Beranda</a>
						</div>
					</div>
				</div>
			</div>
